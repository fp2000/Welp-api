...
exports.postUser = function(req, res) {
	...
	var mailOptions = {
		...
		text: 'Confirm your account with this link: http://welp-main.herokuapp.com/functions/confirmAccountFunction.php?id=' + req.body.userId,
		html: '<p>Welcome to welp</p><p>Account confirmation is required to create an account</p><p>You can confirm yours with this link: http://welp-main.herokuapp.com/functions/confirmAccountFunction.php?id=' + req.body.userId + '</p>'
	};
